...
//{
//
//	bool isThereModelData = false;
//	for(const auto& m : modelTypes)
//	{
//		if(m.first == modelName)
//		{
//			isThereModelData = true;
//			break;
//		}
//	}
//
...
//			primitiveModelObjects.emplace(name, std::make_unique<ModelObject>(objModelDatas[name].get(), userConstBufferData));
//			break;
//		case ModelManager::MODEL_TYPE_OBJ:
//			objModelObjects.emplace(name, std::make_unique<ObjModelObject>(objModelDatas[name].get(), userConstBufferData));
//
//			break;
